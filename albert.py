...
from transformers import AlbertTokenizerFast, TFAlbertForSequenceClassification, AlbertConfig
...
config = AlbertConfig(num_labels=3, return_dict=True, model_type='albert-base-v2')
